...
# Arch Linux Nord colorscheme setup
...
main() {
    ...
    action "Setting up Nord theme (Arch Linux)"

    # - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

    # Set wallpaper
    set_wallpaper "nord" "icy-mountain.png"
    ...
    success "Nord theme setup complete (Arch Linux)"
